...
require_relative '../../app/infrastructure/web_api/queries'
require_relative '../../../../config/environment'

# Initialize the API client with your backend's endpoint
API_URL = 'http://localhost:9292'
api_client = Leaf::WebAPI::API.new(API_URL) # Replace with the correct API endpoint
...
begin
  ...
  response = api_client.create_query(origin, destination, strategy)
